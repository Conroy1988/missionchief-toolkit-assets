...
The feature observes normal AJAX dispatch windows, standalone mission tabs and accessible external extension-modified document roots. Repeated scans are idempotent, do not reinsert an already correctly hosted badge, and replacement rows receive the badge automatically.
