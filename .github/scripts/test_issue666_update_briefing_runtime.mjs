...
assert.equal(metadataVersion, "10.16.6");
...
assert.match(body, /<strong>v10\.16\.6<\/strong>/u);
assert.match(body, /Known-Good Toolkit UI Restoration/u);
...
assert.equal(modal.title, "What’s New & Feature Beacon · v10.16.6");
assert.equal(modal.subtitle, "Known-Good Toolkit UI Restoration");
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.16.6",
  "_blank",
  "noopener,noreferrer",
]);
