...
REPORT = ROOT / "docs/issue-260-final-wrapper-diagnostic.md"


def main() -> None:
    with tempfile.TemporaryDirectory(prefix="issue-260-wrapper-") as temp_dir:
        workspace = Path(temp_dir) / "repo"
        shutil.copytree(ROOT, workspace, ignore=shutil.ignore_patterns(".git", "__pycache__", "*.pyc"))
        package = workspace / ".github/development-packages/fix-issue-260-v4.20.14-final.py"
