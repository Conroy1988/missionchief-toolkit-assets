...
REPORT = ROOT / '.github' / 'diagnostics' / 'issue-175-runner-result.txt'

with tempfile.TemporaryDirectory(prefix='issue-175-runner-') as temp_dir:
...
print(f'Wrote final runner diagnostic: {result.returncode}')
