...
result = subprocess.run(["python3", str(driver)], cwd=root, text=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
...
report.write_text(f"Issue #154 candidate diagnostic\nreturn_code={result.returncode}\n\n{tail}\n", encoding="utf-8")
