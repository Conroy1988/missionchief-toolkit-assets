...
"scanTransportSweepQueue":__mcmsModuleContext=>(async function scanTransportSweepQueue() {
        ...
        const scanPromise = __mcmsModuleContext.Promise.resolve().then(async () => {
            ...
            if(typeof __mcmsModuleContext.pilotCall==='function')await (0,__mcmsModuleContext.pilotCall)({op:'clearReadCache'}).promise;
...
"startTransportSweep":__mcmsModuleContext=>(async function startTransportSweep() {
        ...
        const queue = await (0,__mcmsModuleContext.scanTransportSweepQueue)();
...
"applyStationIconToStation":__mcmsModuleContext=>(async function applyStationIconToStation(item, plan, sourceImage) {
        const baseline = await (0,__mcmsModuleContext.fetchStationIconBuilding)(item.buildingId, { requireIcon: true });
...
"postTransportSweepDiscordReport":__mcmsModuleContext=>(async function postTransportSweepDiscordReport(report=__mcmsModuleContext.transportSweepRuntime.lastReport,{manual=false}={}){
  ...
  try{await (0,__mcmsModuleContext.pilotCall)({op:'discordDraft',account:__mcmsModuleContext.pilot.account(),kind:'sweep',payload:(0,__mcmsModuleContext.buildTransportSweepDiscordPayload)(clean)}).promise;(0,__mcmsModuleContext.showToast)('Sweep report ready · review and send in Discord integrations');await (0,__mcmsModuleContext.pilotCall)({op:'discordOpen'}).promise;return true;}
