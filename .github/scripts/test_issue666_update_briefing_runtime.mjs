...
assert.equal(metadataVersion, "10.18.1");
...
assert.match(body, /<strong>v10\.18\.1<\/strong>/u);
assert.match(body, /Mobile Navigation Overlay Hotfix/u);
...
assert.equal(modal.title, "What’s New & Feature Beacon · v10.18.1");
assert.equal(modal.subtitle, "Mobile Navigation Overlay Hotfix");
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.18.1",
  "_blank",
  "noopener,noreferrer",
]);
