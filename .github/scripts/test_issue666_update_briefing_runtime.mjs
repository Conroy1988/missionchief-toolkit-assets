...
assert.equal(metadataVersion, "10.15.3");
...
assert.match(body, /<strong>v10\.15\.3<\/strong>/u);
assert.match(body, /Live Regression Hotfix/u);
...
assert.equal(modal.title, "What’s New & Feature Beacon · v10.15.3");
assert.equal(modal.subtitle, "Live Regression Hotfix");
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.15.3",
  "_blank",
  "noopener,noreferrer",
]);
