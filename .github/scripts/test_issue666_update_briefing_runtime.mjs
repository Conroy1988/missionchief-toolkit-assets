...
assert.equal(metadataVersion, "10.14.0");
...
assert.match(body, /v10\.14\.0/u);
assert.match(body, /Expansion &amp; Upgrade Planner/u);
...
assert.equal(modal.title, "What’s New & Feature Beacon · v10.14.0");
assert.equal(modal.subtitle, "Expansion & Upgrade Planner");
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.14.0",
  "_blank",
  "noopener,noreferrer",
]);
