...
with tempfile.TemporaryDirectory(prefix="issue391-panel-token-context-v2-") as temporary:
...
payload = [
    "ISSUE391_PANEL_TOKEN_CONTEXT_V2",
...
print(f"Captured panel-token context v2 in {OUTPUT.relative_to(ROOT)}")
