...
- **Fast Map** is an opt-in, session-only MapLibre renderer with an OpenFreeMap vector base, positive ready-state validation, unobstructed top controls, and exact native Leaflet restoration on exit or failure.
