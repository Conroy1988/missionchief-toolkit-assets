...
def main():
 ...
 assert all('Chrome Web Store' in text for text in [readme,help_text])
 assert 'no longer supported' in readme and 'retired userscript' in help_text
 assert 'extension-command-cover.svg' in readme and 'extension-operations.svg' in readme
