...
assert.equal(metadataVersion, "10.13.2");
...
assert.match(body, /v10\.13\.2/u);
assert.match(body, /Mission-safe vehicle visibility/u);
...
assert.equal(modal.title, "What’s New & Feature Beacon · v10.13.2");
assert.equal(modal.subtitle, "Mission-safe vehicle visibility");
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.13.2",
  "_blank",
  "noopener,noreferrer",
]);
