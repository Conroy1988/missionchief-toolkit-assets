...
assert.equal(metadataVersion, "10.9.5");
...
assert.match(body, /v10\.9\.5/u);
assert.match(body, /Complete ALL DISPATCH CENTRES recruitment scans/u);
...
assert.equal(modal.title, "What’s New & Feature Beacon · v10.9.5");
assert.equal(modal.subtitle, "Complete ALL DISPATCH CENTRES recruitment scans");
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.9.5",
  "_blank",
  "noopener,noreferrer",
]);
