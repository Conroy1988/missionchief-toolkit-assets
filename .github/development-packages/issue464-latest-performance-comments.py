...
OUTPUT = ROOT / '.github/diagnostics/issue464-latest-performance-comments.txt'
...
request = urllib.request.Request(url, headers={
    ...
    'User-Agent': 'MissionChief-Toolkit-Issue464-Performance-Status',
...
lines = ['Issue #464 latest performance comments', f'page_count={len(comments)}', '']
