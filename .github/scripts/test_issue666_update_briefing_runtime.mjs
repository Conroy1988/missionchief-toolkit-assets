...
assert.equal(metadataVersion, "10.13.1");
...
assert.match(body, /v10\.13\.1/u);
assert.match(body, /Complete vehicle visibility toggle/u);
...
assert.equal(modal.title, "What’s New & Feature Beacon · v10.13.1");
assert.equal(modal.subtitle, "Complete vehicle visibility toggle");
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.13.1",
  "_blank",
  "noopener,noreferrer",
]);
