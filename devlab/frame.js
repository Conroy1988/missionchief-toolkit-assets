(function () {
  ...
  function fixtureFetch(input) {
    ...
    if (/toolkit-update-manifest|update-manifest\.json/iu.test(url.pathname)) {
      return jsonResponse({ schemaVersion: 1, version: "10.16.2", downloadUrl: "https://tkb-gaming.scot/mission-chief-scripts/map-command-toolkit/install/", sha256: "0".repeat(64) });
    }
  ...
  function installEnvironment() {
    ...
    window.GM_xmlhttpRequest = options => {
      const response = { status: 200, responseText: JSON.stringify({ schemaVersion: 1, version: "10.16.2", downloadUrl: "https://tkb-gaming.scot/mission-chief-scripts/map-command-toolkit/install/", sha256: "0".repeat(64) }) };
    ...
    const state = {
      ...
      updateBriefing: { enabled: false, seenVersion: "10.16.2", seenFeatures: [] },
