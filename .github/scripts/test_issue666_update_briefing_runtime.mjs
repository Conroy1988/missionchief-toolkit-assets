...
assert.equal(metadataVersion, "10.13.3");
...
assert.match(body, /v10\.13\.3/u);
assert.match(body, /Mission-layer-safe vehicle toggle/u);
...
assert.equal(modal.title, "What’s New & Feature Beacon · v10.13.3");
assert.equal(modal.subtitle, "Mission-layer-safe vehicle toggle");
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.13.3",
  "_blank",
  "noopener,noreferrer",
]);
