...
assert.equal(metadataVersion, "10.4.1");
...
assert.match(body, /v10\.4\.1/u);
assert.match(body, /Kilometre-first Measure toolbar/u);
...
assert.equal(modal.title, "What’s New & Feature Beacon · v10.4.1");
assert.equal(modal.subtitle, "Kilometre-first Measure toolbar");
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.4.1",
  "_blank",
  "noopener,noreferrer",
]);
