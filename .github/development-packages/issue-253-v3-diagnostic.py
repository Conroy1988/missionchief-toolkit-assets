...
REPORT = ROOT / "docs/issue-253-v3-package-diagnostic.txt"
...
def main() -> int:
    ...
    REPORT.write_text(
        "Issue #253 post-regex package diagnostic\n"
        f"Return code: {result.returncode}\n\n"
        "===== STDOUT =====\n" + result.stdout + "\n===== STDERR =====\n" + result.stderr,
        encoding="utf-8",
    )
    print(f"Captured Issue #253 post-regex package return code {result.returncode}")
    return 0
