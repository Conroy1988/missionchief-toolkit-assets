...
ROOT=Path(__file__).resolve().parents[2];SELF=Path(__file__).resolve();OUT=ROOT/'.github/diagnostics/issue464-v5-validation-traceback.txt'
with tempfile.TemporaryDirectory(prefix='issue464-v5-validation-') as temp:
