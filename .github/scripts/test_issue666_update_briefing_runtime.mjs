...
assert.equal(metadataVersion, "10.15.1");
...
assert.match(body, /v10\.15\.1/u);
assert.match(body, /Planner Workspace &amp; Native Vehicles/u);
...
assert.equal(modal.title, "What’s New & Feature Beacon · v10.15.1");
assert.equal(modal.subtitle, "Planner Workspace & Native Vehicles");
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.15.1",
  "_blank",
  "noopener,noreferrer",
]);
