...
assert.equal(metadataVersion, "10.14.2");
...
assert.match(body, /v10\.14\.2/u);
assert.match(body, /Native expansion-page discovery hotfix/u);
...
assert.equal(modal.title, "What’s New & Feature Beacon · v10.14.2");
assert.equal(modal.subtitle, "Native expansion-page discovery hotfix");
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.14.2",
  "_blank",
  "noopener,noreferrer",
]);
