...
assert.equal(metadataVersion, "10.5.2");
...
assert.match(body, /v10\.5\.2/u);
assert.match(body, /Responsive Desktop command surface/u);
...
assert.equal(modal.title, "What’s New & Feature Beacon · v10.5.2");
assert.equal(modal.subtitle, "Responsive Desktop command surface");
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.5.2",
  "_blank",
  "noopener,noreferrer",
]);
