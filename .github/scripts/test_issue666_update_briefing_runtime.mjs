...
assert.equal(metadataVersion, "10.5.3");
...
assert.match(body, /v10\.5\.3/u);
assert.match(body, /Balanced Desktop command deck/u);
...
assert.equal(modal.title, "What’s New & Feature Beacon · v10.5.3");
assert.equal(modal.subtitle, "Balanced Desktop command deck");
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.5.3",
  "_blank",
  "noopener,noreferrer",
]);
