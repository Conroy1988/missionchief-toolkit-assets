...
OUTPUT = ROOT / '.github/diagnostics/issue464-performance-correction-v2-traceback.txt'

with tempfile.TemporaryDirectory(prefix='issue464-performance-v2-') as temporary:
    ...
    package = subprocess.run(
        ['python3', '.github/development-packages/issue464-performance-budget-correction.py'],
        cwd=sandbox,
        env=env,
        text=True,
        capture_output=True,
