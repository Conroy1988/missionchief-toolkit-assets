...
assert.equal(metadataVersion, "10.9.3");
...
assert.match(body, /v10\.9\.3/u);
assert.match(body, /Dispatch Recruitment assignment repair/u);
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.9.3",
  "_blank",
  "noopener,noreferrer",
]);
