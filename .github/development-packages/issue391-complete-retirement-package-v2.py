...
with tempfile.TemporaryDirectory(prefix="issue391-complete-retirement-v2-selftest-") as temporary:
    ...
    if result.returncode != 0:
        ...
        raise SystemExit("Issue #391 retirement package v2 failed sandbox self-test")
...
print("Issue #391 retirement package v2 completed; full sandbox self-test passed.")
