...
assert.equal(metadataVersion, "10.9.4");
...
assert.match(body, /v10\.9\.4/u);
assert.match(body, /Dispatch Recruitment assignment immutability/u);
...
assert.equal(modal.title, "What’s New & Feature Beacon · v10.9.4");
assert.equal(modal.subtitle, "Dispatch Recruitment assignment immutability guard");
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.9.4",
  "_blank",
  "noopener,noreferrer",
]);
