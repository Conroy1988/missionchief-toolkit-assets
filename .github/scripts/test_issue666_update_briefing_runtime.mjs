...
assert.equal(metadataVersion, "10.15.2");
...
assert.match(body, /<strong>v10\.15\.2<\/strong>/u);
assert.match(body, /Native Vehicle Toggle Repair/u);
...
assert.equal(modal.title, "What’s New & Feature Beacon · v10.15.2");
assert.equal(modal.subtitle, "Native Vehicle Toggle Repair");
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.15.2",
  "_blank",
  "noopener,noreferrer",
]);
