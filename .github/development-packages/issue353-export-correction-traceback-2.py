...
OUTPUT = ROOT / ".github" / "diagnostics" / "issue353-performance-correction-2.txt"

with tempfile.TemporaryDirectory(prefix="issue353-diagnostic-2-") as directory:
...
OUTPUT.write_text(
    "Issue #353 correction diagnostic 2\n"
