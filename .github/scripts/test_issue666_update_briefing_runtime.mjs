...
assert.equal(metadataVersion, "10.17.3");
...
assert.match(body, /<strong>v10\.17\.3<\/strong>/u);
assert.match(body, /Fast Map Icon Stability Hotfix/u);
...
assert.equal(modal.title, "What’s New & Feature Beacon · v10.17.3");
assert.equal(modal.subtitle, "Fast Map Icon Stability Hotfix");
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.17.3",
  "_blank",
  "noopener,noreferrer",
]);
