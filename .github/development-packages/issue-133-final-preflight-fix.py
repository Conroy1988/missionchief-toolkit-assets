...
workflow = FULL_AUDIT.read_text(encoding="utf-8")
workflow = replace_once(
    workflow,
    '      - ".github/fixtures/mission-marker-ingestion-contract.json"\n',
    '      - ".github/fixtures/mission-marker-ingestion-contract.json"\n      - ".github/fixtures/mission-requirements-contract.json"\n',
    "full audit Mission Requirements fixture trigger",
)
workflow = replace_once(
    workflow,
    '      - ".github/scripts/test_mission_marker_ingestion_contract.py"\n',
    '      - ".github/scripts/test_mission_marker_ingestion_contract.py"\n      - ".github/scripts/test_mission_requirements_contract.py"\n      - ".github/scripts/test_mission_requirements_runtime.js"\n',
    "full audit Mission Requirements test triggers",
)
FULL_AUDIT.write_text(workflow, encoding="utf-8")

for path in (DIAGNOSTIC, DIAGNOSTIC_PACKAGE):
    if path.exists():
        path.unlink()
...
print("Updated Settings/Ops routing inventory and full-audit Mission Requirements preflight")
