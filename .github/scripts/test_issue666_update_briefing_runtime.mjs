...
assert.equal(metadataVersion, "10.15.0");
...
assert.match(body, /v10\.15\.0/u);
assert.match(body, /Resizable Desktop Toolkit Workspace/u);
...
assert.equal(modal.title, "What’s New & Feature Beacon · v10.15.0");
assert.equal(modal.subtitle, "Resizable Desktop Toolkit Workspace");
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.15.0",
  "_blank",
  "noopener,noreferrer",
]);
