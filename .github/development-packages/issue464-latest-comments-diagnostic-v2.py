...
OUT=ROOT/'.github/diagnostics/issue464-latest-comments-v2.txt'
...
for c in comments[-10:]:
    lines += ['='*100,f"id={c.get('id')} created_at={c.get('created_at')} author={(c.get('user') or {}).get('login')}",str(c.get('body') or ''),'']
