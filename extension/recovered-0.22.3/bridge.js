...
(() => {
  ...
  window.addEventListener('message', async event => {
    ...
    if(!['discordReceipt','discordDraft','discordOpen','request','abort','saveBatch','module','job','jobsList','jobsFocus','gameRead','cancelReads','clearReadCache','metrics'].includes(payload.op))return;
    metrics.messages++;
    let response;
    try {
