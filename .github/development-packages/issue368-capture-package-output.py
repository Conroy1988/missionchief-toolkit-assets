...
OUTPUT = ROOT / ".github" / "diagnostics" / "issue368-package-output.txt"

with tempfile.TemporaryDirectory(prefix="issue368-") as temp:
    copy = Path(temp) / "repo"
...
print(f"Captured Issue #368 package output to {OUTPUT.relative_to(ROOT)}")
