...
OUTPUT = ROOT / ".github" / "diagnostics" / "issue353-performance-correction-3.txt"

with tempfile.TemporaryDirectory(prefix="issue353-diagnostic-3-") as directory:
...
OUTPUT.write_text(
    "Issue #353 correction diagnostic 3\n"
