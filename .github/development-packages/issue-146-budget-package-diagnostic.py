...
SOURCE_COMMIT = '9e0e53a8dae6f3fd9dbb11537f6c87d33cd57447'
PACKAGE_PATH = '.github/development-packages/issue-146-single-owner-hotfix-budget.py'
TEMP = ROOT / '.github' / 'development-packages' / 'issue-146-budget-package.payload.py'
REPORT = ROOT / '.github' / 'diagnostics' / 'issue-146-budget-package-failure.txt'
...
REPORT.write_text(
    'Issue #146 budget-package diagnostic\n'
    '====================================\n\n'
    f'Payload return code: {result.returncode}\n\n'
    'Bounded output:\n\n' + output + '\n',
    encoding='utf-8',
)
print('Issue #146 budget-package diagnostic written')
