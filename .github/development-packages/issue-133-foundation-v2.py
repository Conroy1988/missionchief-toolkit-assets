...
replacements = [
    ...
    (
        ...
        "        const styleId = SCRIPT.missionRequirementsDocumentStyleId;",
        "document style creation ownership",
    ),
    (
...
print("Applied Issue #133 foundation v2 and removed temporary inspection artefacts")
