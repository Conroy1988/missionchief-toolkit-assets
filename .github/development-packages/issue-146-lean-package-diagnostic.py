...
SOURCE_COMMIT = 'adda450184e5caff7a364e63cd88aeeb457b12db'
PACKAGE_PATH = '.github/development-packages/issue-146-single-owner-hotfix-lean.py'
TEMP = ROOT / '.github' / 'development-packages' / 'issue-146-lean-package.payload.py'
REPORT = ROOT / '.github' / 'diagnostics' / 'issue-146-lean-package-failure.txt'
...
REPORT.write_text(
    'Issue #146 lean-package diagnostic\n'
    '==================================\n\n'
    f'Payload return code: {result.returncode}\n\n'
    'Bounded output:\n\n' + output + '\n',
    encoding='utf-8',
)
print('Issue #146 lean-package diagnostic written')
