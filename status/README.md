...
- **Latest recorded version:** `10.3.2`
- **State:** Verified public release
- **Canonical path:** `src/MissionChief_Map_Command_Toolkit.user.js`
- **Validated SHA-256:** `c41839cac588837a6d924bb3362a34f49466596a46d6d0ffb0795092a8c88687`
...
- **Last release-state update:** `2026-08-02T12:56:32Z`
