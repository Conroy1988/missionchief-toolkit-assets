...
Selected and Responding capacity may reduce the displayed shortage because those commitments are not yet represented by MissionChief's on-scene state. On-site units are recognised and displayed, but are not subtracted a second time when MissionChief still reports a live missing count; that live count remains authoritative.
