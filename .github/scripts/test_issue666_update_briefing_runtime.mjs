...
assert.equal(metadataVersion, "10.17.4");
...
assert.match(body, /<strong>v10\.17\.4<\/strong>/u);
assert.match(body, /Complete UK Building Filters/u);
...
assert.equal(modal.title, "What’s New & Feature Beacon · v10.17.4");
assert.equal(modal.subtitle, "Complete UK Building Filters");
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.17.4",
  "_blank",
  "noopener,noreferrer",
]);
