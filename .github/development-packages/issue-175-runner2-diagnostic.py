...
REPORT = ROOT / '.github' / 'diagnostics' / 'issue-175-runner2-result.txt'

with tempfile.TemporaryDirectory(prefix='issue-175-runner2-') as temp_dir:
...
print(f'Wrote hardened runner diagnostic: {result.returncode}')
