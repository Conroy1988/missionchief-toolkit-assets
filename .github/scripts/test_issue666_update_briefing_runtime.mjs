...
assert.equal(metadataVersion, "10.17.0");
...
assert.match(body, /<strong>v10\.17\.0<\/strong>/u);
assert.match(body, /Fast Map Replacement Renderer/u);
...
assert.equal(modal.title, "What’s New & Feature Beacon · v10.17.0");
assert.equal(modal.subtitle, "Fast Map Replacement Renderer");
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.17.0",
  "_blank",
  "noopener,noreferrer",
]);
