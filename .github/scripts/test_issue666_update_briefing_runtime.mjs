...
assert.equal(metadataVersion, "10.17.2");
...
assert.match(body, /<strong>v10\.17\.2<\/strong>/u);
assert.match(body, /Fast Map Marker and Route Restoration/u);
...
assert.equal(modal.title, "What’s New & Feature Beacon · v10.17.2");
assert.equal(modal.subtitle, "Fast Map Marker and Route Restoration");
...
assert.deepEqual(opened[0].args, [
  "https://github.com/Conroy1988/missionchief-toolkit-assets/releases/tag/v10.17.2",
  "_blank",
  "noopener,noreferrer",
]);
