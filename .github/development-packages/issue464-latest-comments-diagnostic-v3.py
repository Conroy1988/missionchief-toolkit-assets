...
OUTPUT = ROOT / '.github/diagnostics/issue464-latest-comments-v3.txt'
...
lines = ['Issue #464 latest comment diagnostic v3', f'count={len(comments)}', '']
for comment in comments[-16:]:
    lines.extend([
        '=' * 100,
