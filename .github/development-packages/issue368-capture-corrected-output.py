...
OUTPUT = ROOT / ".github" / "diagnostics" / "issue368-corrected-package-output.txt"

with tempfile.TemporaryDirectory(prefix="issue368-corrected-") as temp:
    copy = Path(temp) / "repo"
...
print(f"Captured corrected Issue #368 package output to {OUTPUT.relative_to(ROOT)}")
